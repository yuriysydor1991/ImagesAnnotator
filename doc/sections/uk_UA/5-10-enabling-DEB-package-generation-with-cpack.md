...
Для того щоб переглянути або змінити параметри створення `deb`-пакетів необхідно відвідати файл `cmake/enablers/packagers/template-project-deb-enabler.cmake`.
