...
Детальніше у файлі відповідальному за встановлення джерела GTest за шляхом `cmake/enablers/template-project-GTest-enabler.cmake` де також можна змінити версію фреймворку тестування тощо.
